...
namespace IMS.Plugins.InMemory
{
    ...
    {
        private List<ProductTransaction> _productionTransactions = new List<ProductTransaction>();
        ...
        public async Task ProduceAsync(string productionNumber, Product product, int quantity, string doneBy)
        {
            ...
            _productionTransactions.Add(new ProductTransaction
            {
        ...
        {
            this._productionTransactions.Add(new ProductTransaction
            {
